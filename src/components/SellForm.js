		...
		return (
			<form className="mb-3" onSubmit={(event) => {
				...
				if (this.state.value === 'KNG') {
						this.props.sellKingTokens(etherAmount)
				}
				else if (this.state.value === 'QEN') {
					this.props.sellQueenTokens(etherAmount)
				}
				else if (this.state.value === 'ROK') {
					this.props.sellRookTokens(etherAmount)
				}
				else if (this.state.value === 'BSP') {
					this.props.sellBishopTokens(etherAmount)
				}
				else if (this.state.value === 'KNT') {
					this.props.sellKnightTokens(etherAmount)
				}
				else if (this.state.value === 'PWN') {
					this.props.sellPawnTokens(etherAmount)
				}
			...
			onChange={(event) => {
				...
				if (this.state.value === 'KNG') {
					...
					this.setState({
						output: tokenAmount / 300
					})
				}
				else if (this.state.value === 'BSP') {
					this.setState({
						output: tokenAmount / 400
					})
				}
				else if (this.state.value === 'KNT') {
					this.setState({
